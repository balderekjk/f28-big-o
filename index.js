...
// ANSWER: I can create a faster function but with the same time complexity
// function findFourth(numbers) {
// 	return numbers[4];
// }
...
// ANSWER: You can improve function slightly but space complexity remains same...
// function getNumbersSquared(numbers) {
//   let answers = [];
//   for (let i = 0; i < numbers.length; i++) {
...
// ANSWER: Each function is basically executing a for loop within a for loop, with a variable parameter that can change depending on user input.
